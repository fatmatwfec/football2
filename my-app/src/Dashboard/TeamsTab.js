          ...
          <div key={team.id} className="glass rounded-[2.5rem] p-6 border border-white/5 hover:border-emerald-500/30 transition-all shadow-2xl relative group overflow-hidden">
            ...
            <div className="space-y-2 mb-8 relative z-10">
              ...
              {team.members?.map((member, index) => (
                <div key={index} className="flex items-center justify-between bg-slate-900/40 p-3 rounded-2xl border border-white/5 group/member hover:bg-slate-900 transition-colors">
                  ...
                  <button 
                    onClick={() => handleRemovePlayer(team.id, team.teamName, member)}
